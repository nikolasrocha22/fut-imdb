...
var syncService_1 = require("./src/syncService");
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    // Deletar dependências dos seeds primeiro
                    _a.sent();
                    return [4 /*yield*/, prisma.prediction.deleteMany({
                            where: { matchId: { startsWith: 'seed-' } }
                        })];
                case 2:
                    _a.sent();
                    return [4 /*yield*/, prisma.aiAnalysis.deleteMany({
                            where: { matchId: { startsWith: 'seed-' } }
                        })];
                case 3:
                    _a.sent();
                    return [4 /*yield*/, prisma.match.deleteMany({
                            where: { id: { startsWith: 'seed-' } }
                        })];
                case 4:
                    deleted = _a.sent();
                    console.log("[OK] Deletados ".concat(deleted.count, " jogos de teste do banco de dados."));
                    // Acionar a sincronização
                    console.log('[OK] Iniciando sincronização com a Football-Data.org + Geração via Gemini AI...');
                    return [4 /*yield*/, (0, syncService_1.syncTodayMatches)()];
                case 5:
                    _a.sent();
